...
`cloud-itonami-0810` is an OSS open-business blueprint for community quarry and stone supply, robotics-premised.

## Maintainers
Maintainers may merge changes that preserve these invariants:
- a robot action the governor refuses is never dispatched to hardware.
- the Quarry Governor remains independent of the advisor.
