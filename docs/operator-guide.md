...
- human sign-off for :high/:safety-critical robot actions (e.g. operating at a quarry face, near personnel or near blast zones)
...
## Operating states
intake : survey : extract : grade : ship : audit
