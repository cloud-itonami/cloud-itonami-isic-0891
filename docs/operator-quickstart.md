# Operator Quickstart — Chemical and Fertilizer Mineral Mining Operations

Shortest path from clone to a verified local dry-run for **ISIC 0891** (`cloud-itonami-isic-0891`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-0891.git
cd cloud-itonami-isic-0891
```
...
- Blueprint governor key: `chem-mineral-governor`
- Likely source path: `chemmineops.governor.cljc`
